...
enum AppStoryboard : String {
    ...
    case Profile, EditProfile, Choir, SideMenu, Notifications, Calendar, Roster, MusicLibrary, Event, Song, SettingsModal, NewEditProfile, Login, Register, Practice, PracticeSettings
