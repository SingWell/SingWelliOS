...
/*!
 @header SSPDSyncTiming.h
 @abstract timing information for synchronisation of playdata to a performance eg for synchronising
 cursor movements to a recorder performance
 @discussion this needs the sync licence
 */
