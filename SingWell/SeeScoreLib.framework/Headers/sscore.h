...
#define sscore_kMaxStavesInPart 4
#define sscore_kMaxBarlinesInSystemPart 500
...
#define sscore_invalid_item_handle 0
...
enum sscore_layoutOptionsFlagBits
{
	...
	sscore_layoutopt_showvoice_bit = 0x20,			// set to show voice numbers beside notes
...
enum sscore_warning
{
	...
	sscore_warning_badaccidental,	// the accidental is inconsistent with note pitch
	sscore_warning_noaccidental,	// the pitch needs an accidental but there isn't one
	sscore_warning_backupunclosed,	// beam/tied/tuplet unclosed at backup element
	sscore_warning_emptybar,		// no note or rest in bar
	sscore_warning_missingtime,		// no time signature in first bar
	sscore_warning_unexpectedNotationOnChordNote, // we don't expect eg tuplet elements on notes with <chord> element
	sscore_warning_duplicateAttributes, // duplicate attributes
	sscore_warning_duplicateTimeSig,// time signature is duplicated
	sscore_warning_duplicateKeySig,	// key signature is duplicated
	sscore_warning_duplicateClef,	// clef is duplicated
	sscore_warning_deprecatedDirectivesInAttributes
};
    
/*!
 @enum sscore_element_type
 @abstract element type for warning
 */
enum sscore_element_type
{
    sscore_element_none,
	...
	sscore_element_note,
	sscore_element_bar,
	sscore_element_timesignature,
	sscore_element_ornament,
	sscore_element_technical,
	sscore_element_articulation,
	sscore_element_dynamics,
	sscore_element_fermata,
	sscore_element_arpeggiate,
	sscore_element_nonarpeggiate,
	sscore_element_accidentalmark,
	sscore_element_attributes,
	sscore_element_direction,
	sscore_element_words,
	sscore_element_barline,
	sscore_element_metronome,
	sscore_element_segno,
	sscore_element_coda,
	sscore_element_harmony,
	sscore_element_rehearsal,
	
	sscore_element_unknown = 1000
};

/*!
 @enum sscore_loadopt_flagbits
 @abstract flag bits for load
 */
enum sscore_loadopt_flagbits
{
	sscore_loadopt_checkxml_bit = 0x1,	// when set various logical tests will be performed after loading and results reported as warnings
    sscore_loadopt_generatebeams_bit = 0x2, // deprecated
	sscore_loadopt_suppressAutoBeamGeneration_bit = 0x4 // set to suppress automatic generation of beam elements when there are no beam elements found in the score
};

/*!
 @enum sscore_texttype
 @abstract type of text determining preset font to use
 */
enum sscore_texttype
{
...
/*!
 @enum sscore_timesig_type
 @abstract a type of time signature
 */
enum sscore_timesig_type {
	sscore_timesig_invalid,
	sscore_timesig_common,
	sscore_timesig_cut,
	sscore_timesig_single_number,
	sscore_timesig_note,
	sscore_timesig_dotted_note,
	sscore_timesig_normal
};

/*!
	@enum sscore_system_stafflocation_e
	@abstract define location relative to the staff
 */
enum sscore_system_stafflocation_e { sscore_system_staffloc_undefined, sscore_system_staffloc_above, sscore_system_staffloc_instaff, sscore_system_staffloc_below, sscore_system_staffloc_outside };

/*!
	 @enum sscore_system_xlocation_e
	 @abstract define x location relative to the system
*/
enum sscore_system_xlocation_e { sscore_system_xloc_undefined, sscore_system_xloc_leftofsystem, sscore_system_xloc_withinsystem, sscore_system_xloc_rightofsystem };
...
typedef struct sscore_loaderror
{
	...
	struct {
		...
		unsigned item_h; // item handle (= sscore_item_handle)
...
/*!
 @struct sscore_warnings
 @abstract describe any xml problems
 */
typedef struct sscore_warnings
{
	int numwarnings; // the number of warnings
	struct {
		enum sscore_warning w; // a warning value
...
typedef struct sscore_timesig
{
	...
	int beattype; // 8 = quaver; 4 = crotchet; 2 = minim etc
} sscore_timesig;
...
typedef struct sscore_layoutoptions
{
	...
	int interStaffPaddingTenths; // use this to add extra space between staves in part (units are tenths of a staff space)
	unsigned dummy[14]; // for future. set to zero
...
/*!
 @struct sscore_header_ext
 @abstract same as sscore_header but with some extra fields
 @discussion all are null-terminated c-style strings or 0
 */
typedef struct sscore_header_ext
{
	const char *work_number;
	const char *work_title;
	const char *movement_number;
...
enum sscore_barlineloc_e { sscore_bl_left, sscore_bl_middle, sscore_bl_right};

/*!
	@struct sscore_partlayout
	@abstract part staff measurement information returned from sscore_system_getstafflayout
 */
...
/*!
	 @struct sscore_barlayout
	 @abstract barline measurement information returned from sscore_system_getbarlayout
*/
...
/*!
 @function sscore_black
 @return black colour
 */
EXPORT sscore_colour_alpha sscore_black();
...
/*!
	@typedef sscore_layout_callback_fn
...
/*!
	...
	@discussion this is much quicker than loading the whole score and reading the header from that, and is suitable
	for presenting file metadata, title, composer etc in  a list of MusicXML files.
...
/*!
	 @function sscore_getxmlwarnings
	 @abstract report any xml problems
	 @param sc the sscore pointer
*/
EXPORT sscore_warnings sscore_getxmlwarnings(sscore *sc);
...
/*!
 @function sscore_numstavesforpart
 @abstract return the number of staves for the part
 @param sc the score
 @param partindex the part index [0..]
 @return the number of staves in this part (1..2)
 */
EXPORT int sscore_numstavesforpart(const sscore *sc, int partindex);
...
EXPORT const char *sscore_instrumentnameforpart(const sscore *sc, int partindex);
	...
	/*!
	 @function sscore_hasLyricsInPart
	 @abstract true if the part/staff has lyrics
	 @param sc the sscore pointer returned from sscore_load*
	 @param partindex the index of the part [0..numparts-1]
	 @param staffindex the index of the part [0..numparts-1]
	 @return true if the part/staff has lyrics
	 */
EXPORT bool sscore_hasLyricsInPart(const sscore *sc, int partindex, int staffindex);
	...
	@param opt layout options or NULL
...
/*!
	 @function sscore_getheader_ext
	 @abstract get the xml score-header information
	 @discussion NB The returned pointers inside header are owned by sc. The caller should copy any required data
	 @param sc the sscore pointer returned from sscore_load*
	 @param header pointer to a struct of type sscore_header_ext to receive the data
 */
EXPORT void sscore_getheader_ext(const sscore *sc, sscore_header_ext *header);
...
/*!
	@function sscore_system_magnification
	@abstract return the default magnification at which the system will be drawn
	@param sys the system
	@return the magnification - 1.0 is a close approximation to a standard printed score with 6mm staff height
 */
EXPORT float sscore_system_magnification(const sscore_system *sys);


/*!
	 @function sscore_system_widthTruncated
	 @abstract is the magnification too high for the current width?
	 @param sys the system
	 @return true if the system cannot be drawn in the specified width at the current magnification
*/
EXPORT bool sscore_system_widthTruncated(const sscore_system *sys);

/*!
	 @function sscore_system_staff_bottom_ypos
	 @abstract return bottom ypos of the staff in the part
	 @param sys the system
	 @param partIndex the part index [0..]
	 @param staffIndex the staff index [0..1]
	 @return the distance from the top of the system to the bottom line of the given staff
 */
EXPORT float sscore_system_staff_bottom_ypos(const sscore_system *sys, int partIndex, int staffIndex);

/*!
	 @function sscore_system_staff_height
	 @abstract return the height of the staff in the part
	 @param sys the system
	 @param partIndex the part index [0..]
	 @param staffIndex the staff index [0..1]
	 @return the height of the staff from the bottom line to the top line
 */
EXPORT float sscore_system_staff_height(const sscore_system *sys, int partIndex, int staffIndex);

/*!
	 @function sscore_system_numLyricLines
	 @abstract the number of lyric lines in the system
	 @discussion This may be less than sscore_con_numLyricLinesInPart which returns the number
	of lyric lines in the whole part
	 @param sys the system
	 @param partIndex the part index [0..]
	 @param staffIndex the staff index [0..1]
	 @return the number lines of of lyrics
 */
EXPORT int sscore_system_numLyricLines(const sscore_system *sys, int partIndex, int staffIndex);

/*!
	 @function sscore_system_lyricBaseline
 ...
 */
EXPORT float sscore_system_lyricBaseline(const sscore_system *sys, int partIndex, int staffIndex, int lyricIndex);
...
/*!
	@function sscore_system_staffindexforypos
	@abstract return the nearest staff index for a y-coord in the system/part
	@param sys the system
	@param partindex the 0-based part index
	@param ypos the y coord
	@return the 0-based index of the closest staff in the system/part containing this y coord
*/
EXPORT int sscore_system_staffindexforypos(const sscore_system *sys, int partindex, float ypos);
...
/*!
	 @function sscore_system_centreStaffY
	 @abstract return the y coord of the centre of a staff in the system
	 @param sys the system
	 @param partIndex the 0-based part index
	 @param staffIndex the 0-based staff index
	 @return the y coord of the centre of a staff in the system
*/
EXPORT float sscore_system_centreStaffY(const sscore_system *sys, int partIndex, int staffIndex);

/*!
	@function sscore_system_stafflocationforypos
	@abstract is a y-location above or below the staff returned by sscore_system_staffindexforypos?
	@param sys the system
	@param partindex the 0-based part index
	@param staffindex the 0-based staff index
	@param maxLedgers the number of ledgers before this is considered outside the staff rather than above/below
	@param ypos the y position
	@return the above/instaff/below location relative to the staff
 */
EXPORT enum sscore_system_stafflocation_e sscore_system_stafflocationforypos(const sscore_system *sys, int partindex, int staffindex, int maxLedgers, float ypos);
	
/*!
	 @function sscore_system_systemxlocationforxpos
	 @abstract return info about where a coord is wrt the given system
	 @param sys the system
	 @param xpos_cg the x coordinate
	 @return the left/within/right location relative to the system
*/
EXPORT enum sscore_system_xlocation_e sscore_system_systemxlocationforxpos(const sscore_system *sys, float xpos_cg);

/*!
	 @function sscore_system_stafflinespaceindexforypos
	 @abstract return the line/space index increasing upwards from the bottom line of the staff 
		for the given y coordinate
	 @discussion bottom line = 0; bottom space = 1; bottom ledger = -2; top line = 8
	 @param sys the system
	 @param partindex the 0-based part index
	 @param staffindex the 0-based staff index
	 @param ypos the y position
	 @return the line/space index from the staff bottom line
*/
EXPORT int sscore_system_stafflinespaceindexforypos(const sscore_system *sys, int partindex, int staffindex, float ypos);
...
/*!
	 @function sscore_system_getstafflayout
	 @abstract return information (in result) about the dimensions of the staves in a part
	 @param sys the system being interrogated
	 @param partindex the 0-based part index
	 @return the staff layout information
*/
EXPORT sscore_stafflayout sscore_system_getstafflayout(const sscore_system *sys, int partindex);
	
/*!
	 @function sscore_system_getbarlayout
	 @abstract return information (in result) about the dimensions of the barlines in a part
	 @param sys the system being interrogated
	 @param partindex the 0-based part index
	 @return the bar layout information
*/
EXPORT sscore_barlayout sscore_system_getbarlayout(const sscore_system *sys, int partindex);
	
/*!
	 @function sscore_system_pointstofontsize
	 @abstract get fontsize for points value
	 @param sys the system being interrogated
	 @param points the point size
	 @return fontsize for points value
*/
EXPORT float sscore_system_pointstofontsize(const sscore_system *sys, float points);
	
/*!
	 @function sscore_system_magnify
	 @abstract magnify the single system with a single part
	 @param sc the score
	 @param sys the system
	 @param partIndex the part index
	 @return a new magnified system
 */
EXPORT sscore_system *sscore_system_magnify(sscore *sc, const sscore_system *sys, int partIndex);
...
/*!
 @function sscore_stringforwarning
 @abstract get a string for enum sscore_warning
 */
EXPORT const char *sscore_stringforwarning(enum sscore_warning warn);
