...
enum sscore_dopt_colour_render_flags_e
{
	...
	sscore_dopt_colour_pedal	= 0x4000,
	sscore_dopt_colour_dynamics = 0x8000,
	sscore_dopt_colour_slur		= 0x10000,
	sscore_dopt_colour_tie		= 0x20000,
	sscore_dopt_colour_wedge	= 0x40000,
	sscore_dopt_colour_tuplet	= 0x80000,
...
enum sscore_dopt_flags_e
{
	sscore_dopt_showedithandles = 0x1,	// display editing handles on slurs/ties/wedges
	sscore_dopt_showvoicetracks = 0x2	// display 'tracks' belween notes and rests for voices
};
	
/*! 
	@struct sscore_drawoptions
	@abstract define special options for rendering individual score items (note/clef/timesig/keysig) in a system.
	@discussion Used in sscore_dopt_system_draw
 */
